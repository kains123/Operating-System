...
_scheduler_unlock_test:     file format elf32-i386
...
int main(int argc, char *argv[])
{
   ...
   e:	83 ec 10             	sub    $0x10,%esp
	schedulerUnlock(20187192);
  11:	68 38 08 34 01       	push   $0x1340838
  16:	e8 20 03 00 00       	call   33b <schedulerUnlock>
  exit();
